        ...
        <div className="min-h-screen bg-slate-50 flex flex-col">
            ...
            <main className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 flex flex-col gap-8 relative">
                ...
                {status === SolverStatus.IDLE && !result && (
                    <div className="text-center py-10 animate-fade-in">
                        ...
                        <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                            ...
                            <span className="font-semibold text-indigo-600">Resoluciones detalladas paso a paso.</span>
                        </p>
                    </div>
                )}
                ...
                {status === SolverStatus.ERROR && (
                    <div className="w-full max-w-3xl mx-auto p-4 bg-red-50 border border-red-200 rounded-xl flex items-center text-red-700 animate-shake">
            ...
            <button 
                ...
                className="fixed bottom-6 right-6 p-4 bg-white text-indigo-600 rounded-full shadow-2xl hover:bg-indigo-50 border border-indigo-100 z-50 transition-transform hover:scale-105 active:scale-95"
                title="Historial"
            >
